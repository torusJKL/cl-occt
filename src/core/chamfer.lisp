...
(defun chamfer-edges (shape edges distance)
  ...
  EDGES is a list of edge shapes.  Returns a new shape, or NIL if
  SHAPE is null.
...
(defun chamfer-edge-asymmetric (shape edge distance1 distance2)
  ...
  adjacent to the edge.  Returns a new shape, or NIL if SHAPE or
  EDGE is null.
...
(defun chamfer-edge-on-face (shape edge distance face)
  ...
  chamfer face.  Returns a new shape, or NIL if SHAPE or EDGE is null.
