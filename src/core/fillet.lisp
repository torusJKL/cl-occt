...
(defun fillet-edges (shape edges radius)
  ...
  **Returns:** a new shape with all specified edges filleted, or `nil` if `shape` is null.
...
(defun fillet-edge-variable (shape edge param-radius-pairs)
  ...
  - **param-radius-pairs** a list of (parameter radius) pairs, where
  parameter ranges from 0.0 to 1.0 along the edge.
